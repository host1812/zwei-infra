...
New-AzResourceGroupDeployment -Verbose -ResourceGroupName rg-ServiceX -TemplateFile $PSScriptRoot/Bicep/appInsights.bicep -TemplateParameterFile $PSScriptRoot/Parameters/appInsights.parameters.jsonc
